...
('js_escape_single_quote', '''${js_escape(input)}''', r'whee \u0027 zing'.encode('utf8'), {'input': 'whee \' zing'}),
('js_escape_slash', '''${js_escape(input)}''', r'whee \u005C zork'.encode('utf8'), {'input': 'whee \\ zork'}),
('js_escape_double_quote', '''${js_escape(input)}''', r'whee \u0022'.encode('utf8'), {'input': 'whee "'}),
('js_escape_right_angle', '''${js_escape(input)}''', r'whee \u003E'.encode('utf8'), {'input': 'whee >'}),
('js_escape_left_angle', '''${js_escape(input)}''', r'whee \u003C'.encode('utf8'), {'input': 'whee <'}),
('js_escape_ampersand', '''${js_escape(input)}''', r'whee \u0026'.encode('utf8'), {'input': 'whee &'}),
('js_escape_equals', '''${js_escape(input)}''', r'whee \u003D'.encode('utf8').encode('utf8'), {'input': 'whee ='}),
('js_escape_semicolon', '''${js_escape(input)}''', r'whee \u003B'.encode('utf8'), {'input': 'whee ;'}),
