...
('js_escape_single_quote', '''${js_escape(input)}''', rb'whee \u0027 zing', {'input': 'whee \' zing'}),
('js_escape_slash', '''${js_escape(input)}''', rb'whee \u005C zork', {'input': 'whee \\ zork'}),
('js_escape_double_quote', '''${js_escape(input)}''', rb'whee \u0022', {'input': 'whee "'}),
('js_escape_right_angle', '''${js_escape(input)}''', rb'whee \u003E', {'input': 'whee >'}),
('js_escape_left_angle', '''${js_escape(input)}''', rb'whee \u003C', {'input': 'whee <'}),
('js_escape_ampersand', '''${js_escape(input)}''', rb'whee \u0026', {'input': 'whee &'}),
('js_escape_equals', '''${js_escape(input)}''', rb'whee \u003D', {'input': 'whee ='}),
('js_escape_semicolon', '''${js_escape(input)}''', rb'whee \u003B', {'input': 'whee ;'}),
